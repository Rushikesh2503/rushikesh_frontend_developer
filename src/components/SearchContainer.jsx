        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-6">
          ...
          <div className="sm:col-span-6 lg:col-span-1">
            ...
            >
              ...
              {capsuleStatusOpt && capsuleStatusOpt.map((option, index) => (
          ...
          {/* Apply Filter Button */}
          <div className="sm:col-span-6 lg:col-span-1">
            <button className="w-full border border-white text-white py-2 px-4 rounded-md shadow-sm sm:text-sm"  onClick={(e) => {
          handelFilters();
        }}>
              Apply Filter
            </button>
